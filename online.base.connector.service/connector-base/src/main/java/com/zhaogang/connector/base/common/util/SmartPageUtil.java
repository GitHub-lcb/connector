package com.zhaogang.connector.base.common.util;
...
public class SmartPageUtil {
     ...
     * 构建排序
     */
    public static void buildSort(QueryWrapper<?> queryWrapper, List<PageParam.SortItem> sortItemList) {
        ...
        for (PageParam.SortItem sortItem : sortItemList) {
            ...
            queryWrapper.orderBy(true, sortItem.getIsAsc(), sortItem.getColumn());
        }
    }
