...
import com.zhaogang.connector.base.module.support.job.api.domain.SmartJobMsg;
import com.zhaogang.connector.base.module.support.job.config.SmartJobAutoConfiguration;
import com.zhaogang.connector.base.module.support.job.core.SmartJob;
import com.zhaogang.connector.base.module.support.job.core.SmartJobExecutor;
import com.zhaogang.connector.base.module.support.job.core.SmartJobLauncher;
import com.zhaogang.connector.base.module.support.job.repository.SmartJobRepository;
...
public class SmartJobClientManager {
    ...
    public SmartJobClientManager(SmartJobLauncher jobLauncher,
        ...
        log.info("==== job ==== client-manager init");
    }
