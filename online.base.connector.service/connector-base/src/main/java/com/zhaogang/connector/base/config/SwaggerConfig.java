...
import com.zhaogang.connector.base.common.swagger.SmartOperationCustomizer;
...
public class SwaggerConfig {
    ...
    public OpenAPI api() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("Connector 接口文档")
                        .contact(new Contact().name("连接器").email("zhaogang.com").url("https://www.zhaogang.com"))
                        .version("v3.X")
