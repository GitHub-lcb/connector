...
import com.zhaogang.connector.base.module.support.dict.domain.form.*;
...
import com.zhaogang.connector.base.module.support.dict.service.DictService;
...
public class AdminDictController extends SupportBaseController {
    ...
    @Operation(summary = "添加 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "更新 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "启用/禁用 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "单个删除 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 分页查询 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 启用/禁用 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 添加 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 更新 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 批量删除 @author 连接器-主任-卓大")
    ...
    @Operation(summary = "字典数据 单个删除 @author 连接器-主任-卓大")
