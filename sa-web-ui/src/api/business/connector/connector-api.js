...
export const connectorApi = {
  ...
  // 导出
  exportRoute: () => {
    return getDownload('/connector/route/export');
  },
  
  // 批量删除
  batchDelete: (idList) => {
    return postRequest('/connector/route/batchDelete', idList);
  },
  
  // 导入
  importRoute: (file) => {
    return postRequest('/connector/route/import', file);
  },
  ...
  // 导出日志
  exportRouteLog: (param) => {
    return postRequest('/connector/route/log/export', param, { responseType: 'blob' });
  },
